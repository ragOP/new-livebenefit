...
import HomeCall from "./components/CallToAction";
...
export default function Home() {
  ...
  useEffect(() => {
    const initialMessages = [
      ...
      {
        text: "Emily this side. Let’s find out if you qualify for the Spending Allowance Benefit — it’s quick and only takes 2 minutes!",
        sender: "bot",
  ...
  return (
    ...
    >
      <div className="bg-[#4169E1] text-white p-4 flex items-center gap-2 shadow-md sticky top-0 right-0 left-0 z-10 h-16">
        <img
          src={agent}
          alt="Psychic Master"
      ...
      <div className="flex-1 p-4 space-y-2 overflow-y-auto flex flex-col mt-[1%] pb-52">
        ...
        {finalMessage && <HomeCall finalMessage={finalMessage} switchNumber={switchNumber}/>}
